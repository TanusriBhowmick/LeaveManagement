...
<input id="medleaves" name="medleaves" type="number"  value="<?php echo htmlentities($result->medleaves);?>" autocomplete="off" readonly>
 </div>
...
<input id="casleaves" name="casleaves" type="number"  value="<?php echo htmlentities($result->casualLeaves);?>" autocomplete="off" readonly>
 </div>

 <div class="input-field col m6 s12">
<label for="resLeaves">Restricted Leaves</label>
<input id="resLeaves" name="resLeaves" type="number"  value="<?php echo htmlentities($result->resLeaves);?>" autocomplete="off" readonly>
 </div>                                                  
